  ...
  render() {
    return (
      <main className="App container">
        ...
        <ArtList artList={this.state.artList} artPosters={this.state.artList.map((art) => art.poster)} token={this.state.actualToken} editArt={this.editArt} deleteArt={this.deleteArt} />
        <Footer />
      </main>
    )
  }
