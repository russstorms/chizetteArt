      ...
      <ParallaxProvider className="App container">
        ...
        {!this.state.filteredTerm ?
          <div className="wrapper2">
            <ScrollAnimation animateIn="zoomInUp" animateOut="fadeOut"><div className="art"><span className="artA">A</span><span className="artR">r</span><span className="artT">t</span></div><div onClick={this.splashFilterArt} className="viewAll1"><span className="view" data-medium="Art">View Art</span><span className="arrowIcons"><i className="small material-icons icon viewAllIcons">chevron_right</i></span></div></ScrollAnimation>
            <ScrollAnimation animateIn="zoomInUp" animateOut="fadeOut"><div className="jewelry"><span className="jewelryJ">J</span><span className="jewelryE">e</span><span className="jewelryW">w</span><span className="jewelryE2">e</span><span className="jewelryL">l</span><span className="jewelryR">r</span><span className="jewelryY">y</span></div><div onClick={this.splashFilterArt} className="viewAll2"><span className="view" data-medium="Jewelry" >View Jewelry</span><span className="arrowIcons"><i className="small material-icons icon viewAllIcons">chevron_right</i></span></div></ScrollAnimation>
            <ScrollAnimation animateIn="zoomInUp" animateOut="fadeOut"><div className="photography"><span className="photographyP">P</span><span className="photographyH">h</span><span className="photographyO">o</span><span className="photographyT">t</span><span className="photographyO2">o</span><span className="photographyG">g</span><span className="photographyR">r</span><span className="photographyA">a</span><span className="photographyP2">p</span><span className="photographyH2">h</span><span className="photographyY">y</span></div><div onClick={this.splashFilterArt} className="viewAll3"><span className="view" data-medium="Photography">View Photography</span><span className="arrowIcons"><i className="small material-icons icon viewAllIcons">chevron_right</i></span></div></ScrollAnimation>
          </div>
        : null}
