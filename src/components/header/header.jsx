      ...
      <div className="nav">
        <div className="logoAndTitle">
          <a href="/chizetteart">
            ...
            <Sidebar filterArt={this.props.filterArt} toggleContactMe={this.props.toggleContactMe} logoutClick={this.props.logoutClick} token={this.props.token} postArt={this.props.postArt} />
