...
export default class chizetteArt extends Component {
  constructor(props) {
    super(props)
    this.state = {
      artList: [],
    ...
    return (
      <ParallaxProvider className="App container">
        ...
        <ArtList 
          ...
          artList={filterLogic}
          artPosters={filterLogic} 
          token={this.state.actualToken}
          editArt={this.editArt}
          deleteArt={this.deleteArt}
        />
        {!this.state.contactMe && <Crystal />}
        {this.state.contactMe && <Contact contactMe={this.state.contactMe} />}
        <Footer />
      </ParallaxProvider>
    )
  }
