	...
	render() {
		return (
			<form className="loginForm" onSubmit={this.onSubmit}>
				...
				<i className="material-icons prefix"></i>
				<i className="fas fa-user-secret loginIcons"></i><input id="icon_lock" className="inputs" onChange={this.onUsernameChange} name="password" autoComplete="off" placeholder="Secret Code" type="password" />
				</label>
